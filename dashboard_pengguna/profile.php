...
$query = mysqli_query($conn, "SELECT * FROM user WHERE id='$id' AND role='pengguna'");
$user = mysqli_fetch_assoc($query);

if (!$user) {
    die("Data user tidak ditemukan atau session tidak valid");
}
?>
                ...
                <div class="row">
                    ...
                    <div class="menu-section">
                        ...
                        <div class="profile-menu">
                            ...
                            <a href="#" class="menu-item" data-toggle="modal" data-target="#modalPanduan">
                                <div class="menu-left">
                            ...
                            <a href="#" class="menu-item" data-toggle="modal" data-target="#modalAdmin">
                                <div class="menu-left">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ol>
                    ...
                    <li>Pilih <b> Tanggal </b> yang ingin dipinjam.</li>
                    <li>Isi formulir peminjaman dengan lengkap.</li>
                    <li>Pilih sarana atau prasarana yang ingin dipinjam.</li>
                    <li>Klik tombol <b>Ajukan Peminjaman</b>.</li>
                    <li>Tunggu proses verifikasi oleh admin.</li>
                    <li>Lihat status peminjaman pada menu Riwayat Peminjaman.</li>
                    <li>Gunakan sarana sesuai jadwal yang telah disetujui.</li>
                </ol>

                <div class="alert alert-primary">
                    <i class="fas fa-info-circle"></i>
                    Pastikan data yang diinput benar agar proses persetujuan berjalan lancar.
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    <a href="https://wa.me/6282117821368"
                       target="_blank"
