       ...
       <!-- Main Content -->
        <div class="main">
          <div class="topbar-tambah">
            ...
            ?>
            <form class="form-container" method="post" action="update_peralatan.php"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label>Gambar :</label>
                  <input type="file" name="gambar" class="form-control "value="<?= $d['gambar'] ?>">
                </div>
